...
* Gained experience with Redis CLI and Jedis Java client.
* Learned to use Sets and Hashes for user sessions and structured objects (polls).
* Implemented a cache for aggregated poll votes with proper hit/miss handling and TTL.
